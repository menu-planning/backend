...
from old_tests_v0.contexts.recipes_catalog.core.adapters.client.repositories.data_factories.menu.menu_domain_factories import (
    create_menu_meal_kwargs,
)
...
def create_menu_meal_orm_kwargs(**kwargs) -> dict[str, Any]:
    ...
    final_kwargs = {
        ...
        "menu_id": kwargs.get(
            "menu_id", f"menu_{((menu_meal_counter - 1) % 10) + 1:03d}"
        ),  # Link to a menu
    }
...
def create_menus_with_tags_orm(
