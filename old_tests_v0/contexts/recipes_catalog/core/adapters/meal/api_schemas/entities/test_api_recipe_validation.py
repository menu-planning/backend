...
class TestApiRecipeErrorHandling:
    ...
    def test_from_domain_error_scenarios(self, edge_case_recipes):
        ...
        domain_recipe = create_recipe_domain_from_api(
            edge_case_recipes["empty_collections"]
        )
    ...
    def test_to_orm_kwargs_error_scenarios(
        self, simple_recipe, complex_recipe, edge_case_recipes
    ):
