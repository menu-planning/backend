...
from old_tests_v0.contexts.recipes_catalog.core.adapters.meal.api_schemas.value_objects.data_factories.api_rating_data_factories import (
    create_api_rating,
...
from old_tests_v0.utils.counter_manager import get_next_api_recipe_id
        ...
        "rating_scenarios": [
            {
                "taste": 5,
                "convenience": 3,
                "comment": "Incredible authentic flavor but requires technique",
            },
            {
                "taste": 4,
                "convenience": 4,
                "comment": "Delicious and quicker than expected",
            },
            {
                "taste": 5,
                "convenience": 2,
                "comment": "Perfect taste but tricky timing",
            },
        ],
    },
    {
        ...
        "rating_scenarios": [
            {
                "taste": 4,
                "convenience": 5,
                "comment": "Healthy and very convenient for meal prep",
            },
            {
                "taste": 3,
                "convenience": 4,
                "comment": "Good for health goals, tasty enough",
            },
            {
                "taste": 5,
                "convenience": 5,
                "comment": "Perfect balance of nutrition and flavor",
            },
        ],
    },
    {
        ...
        "rating_scenarios": [
            {
                "taste": 5,
                "convenience": 2,
                "comment": "Amazing comfort food but takes all day",
            },
            {
                "taste": 4,
                "convenience": 3,
                "comment": "Worth the time investment for flavor",
            },
            {
                "taste": 5,
                "convenience": 4,
                "comment": "Perfect for slow cooker - set and forget",
            },
        ],
    },
    {
        ...
        "rating_scenarios": [
            {
                "taste": 5,
                "convenience": 4,
                "comment": "Authentic Thai flavors, surprisingly easy",
            },
            {
                "taste": 4,
                "convenience": 3,
                "comment": "Great taste but hard to find some ingredients",
            },
            {
                "taste": 5,
                "convenience": 5,
                "comment": "Quick, delicious, and satisfying",
            },
        ],
    },
    {
        ...
        "rating_scenarios": [
            {
                "taste": 5,
                "convenience": 2,
                "comment": "Absolutely delicious but timing is tricky",
            },
            {
                "taste": 5,
                "convenience": 3,
                "comment": "Worth the effort for special occasions",
            },
            {
                "taste": 4,
                "convenience": 4,
                "comment": "Easier than expected and very impressive",
            },
        ],
    },
]
...
def create_api_recipe_tag(**kwargs) -> ApiTag:
    ...
    final_kwargs = {
        ...
        **{
            ...
            if k not in ["key", "value", "author_id", "type", "post_fix"]
        },
    }
...
def create_api_recipe_kwargs(**kwargs) -> dict[str, Any]:
    ...
    recipe_counter = get_next_api_recipe_id()
    scenario = REALISTIC_RECIPE_SCENARIOS[
        (recipe_counter - 1) % len(REALISTIC_RECIPE_SCENARIOS)
    ]
    ...
    if "tags" in kwargs:
        ...
        for tag_string in scenario["tags"]:
            ...
            if ":" in tag_string:
                ...
                tag = create_api_recipe_tag(
                    key=key, value=value, author_id=recipe_author_id
                )
                tags.append(tag)
            else:
                tag = create_api_recipe_tag(
                    key="general", value=tag_string, author_id=recipe_author_id
                )
                tags.append(tag)
        tags = frozenset(tags)
    ...
    final_kwargs = {
        ...
        "average_convenience_rating": kwargs.get(
            "average_convenience_rating", avg_convenience
        ),
...
def create_api_recipe_from_json(json_data: str | None = None, **kwargs) -> ApiRecipe:
    """
                ...
                converted[key] = [
                    {
                        ...
                        "unit": (
                            ...
                            if isinstance(ingredient.unit, MeasureUnit)
    ...
    final_kwargs = {
        ...
        "ingredients": kwargs.get(
            ...
            frozenset(
                [
                    create_api_ingredient(
                        name="Bread", quantity=2.0, unit=MeasureUnit.SLICE, position=0
                    ),
                    create_api_ingredient(
                        name="Butter",
                        quantity=1.0,
        ...
        "tags": kwargs.get(
            ...
            frozenset(
                [
                    ...
                    create_api_recipe_tag(
                        key="meal-type", value="breakfast", author_id=recipe_author_id
                    ),
                ]
            ),
        ),
        "ratings": kwargs.get(
            ...
            frozenset(
                [
                    create_api_rating(
                        taste=3, convenience=5, comment="Simple but effective"
                    )
                ]
            ),
        ),
...
def create_complex_api_recipe(**kwargs) -> ApiRecipe:
    ...
    complex_ingredients = frozenset(
        [
            ...
            create_api_ingredient(
                name="Mushrooms", quantity=300.0, unit=MeasureUnit.GRAM, position=7
            ),
            create_api_ingredient(
                name="Heavy Cream",
                quantity=200.0,
            ...
            create_api_ingredient(
                name="Butter", quantity=100.0, unit=MeasureUnit.GRAM, position=9
            ),
        ]
    )
    ...
    complex_ratings = frozenset(
        [
            create_excellent_rating(
                comment="Restaurant-quality dish! Worth every minute of preparation."
            ),
            create_mixed_rating(
                comment="Amazing flavors but very time-consuming and requires skill."
            ),
            create_api_rating(
                taste=4,
                convenience=2,
                comment="Impressive results but not for beginners.",
            ),
        ]
    )
    ...
    complex_tags = frozenset(
        [
            create_api_recipe_tag(
                key="cuisine", value="french", author_id=recipe_author_id
            ),
            create_api_recipe_tag(
                key="difficulty", value="expert", author_id=recipe_author_id
            ),
            create_api_recipe_tag(
                key="occasion", value="special-occasion", author_id=recipe_author_id
            ),
            create_api_recipe_tag(
                key="cooking-method", value="oven", author_id=recipe_author_id
            ),
            create_api_recipe_tag(
                key="mood", value="impressive", author_id=recipe_author_id
            ),
        ]
    )
    ...
    final_kwargs = {
        ...
        "description": kwargs.get(
            "description",
            "Classic French dish featuring beef tenderloin wrapped in puff pastry with mushroom duxelles and pâté. A true test of culinary skill.",
        ),
        "instructions": kwargs.get(
            "instructions",
            "1. Sear beef tenderloin on all sides. 2. Prepare mushroom duxelles by sautéing mushrooms until moisture evaporates. 3. Wrap beef in plastic with duxelles, chill 30 minutes. 4. Roll out puff pastry. 5. Wrap beef in pastry, seal edges. 6. Egg wash and score. 7. Bake at 400°F for 25-30 minutes. 8. Rest 10 minutes before slicing.",
        ),
        ...
        "utensils": kwargs.get(
            "utensils",
            "Large skillet, baking sheet, rolling pin, pastry brush, meat thermometer, sharp knife, cutting board",
        ),
        "notes": kwargs.get(
            "notes",
            "This is an advanced recipe requiring precise timing and technique. Use a meat thermometer for perfect doneness. Allow beef to rest before wrapping to prevent pastry from becoming soggy.",
        ),
...
def create_vegetarian_api_recipe(**kwargs) -> ApiRecipe:
    ...
    vegetarian_ingredients = frozenset(
        [
            ...
            create_api_ingredient(
                name="Tomatoes", quantity=400.0, unit=MeasureUnit.GRAM, position=3
            ),
            create_api_ingredient(
                name="Mozzarella", quantity=200.0, unit=MeasureUnit.GRAM, position=4
            ),
            create_spice_ingredient(name="Oregano", quantity=1.0, position=5),
            create_spice_ingredient(name="Basil", quantity=2.0, position=6),
            create_api_ingredient(
                name="Olive Oil", quantity=3.0, unit=MeasureUnit.TABLESPOON, position=7
            ),
        ]
    )
    ...
    final_kwargs = {
        ...
        "description": kwargs.get(
            "description",
            "Layered vegetable gratin with Mediterranean flavors, perfect for vegetarians.",
        ),
        "instructions": kwargs.get(
            "instructions",
            "1. Slice vegetables thinly. 2. Layer in baking dish with cheese and herbs. 3. Drizzle with olive oil. 4. Bake at 375°F for 45 minutes until golden.",
        ),
        ...
        "tags": kwargs.get(
            ...
            frozenset(
                [
                    create_api_recipe_tag(
                        key="diet", value="vegetarian", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="cuisine", value="mediterranean", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="cooking-method", value="oven", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="meal-type", value="dinner", author_id=author_id
                    ),
                ]
            ),
        ),
...
def create_high_protein_api_recipe(**kwargs) -> ApiRecipe:
    ...
    high_protein_ingredients = frozenset(
        [
            ...
            create_api_ingredient(
                name="Greek Yogurt", quantity=150.0, unit=MeasureUnit.GRAM, position=1
            ),
            create_api_ingredient(
                name="Eggs", quantity=2.0, unit=MeasureUnit.UNIT, position=2
            ),
            create_api_ingredient(
                name="Quinoa", quantity=100.0, unit=MeasureUnit.GRAM, position=3
            ),
            create_api_ingredient(
                name="Almonds", quantity=30.0, unit=MeasureUnit.GRAM, position=4
            ),
    ...
    final_kwargs = {
        ...
        "description": kwargs.get(
            "description",
            "Nutrient-dense bowl packed with high-quality protein sources for muscle building and recovery.",
        ),
        ...
        "tags": kwargs.get(
            ...
            frozenset(
                [
                    create_api_recipe_tag(
                        key="lifestyle", value="fitness", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="diet", value="high-protein", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="meal-type", value="lunch", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="prep-style", value="meal-prep", author_id=author_id
                    ),
                ]
            ),
        ),
...
def create_quick_api_recipe(**kwargs) -> ApiRecipe:
    ...
    final_kwargs = {
        ...
        "description": kwargs.get(
            "description", "Quick and healthy stir fry perfect for busy weeknights."
        ),
        "instructions": kwargs.get(
            "instructions",
            "1. Heat oil in wok. 2. Add vegetables, stir-fry 3 minutes. 3. Add sauce, cook 2 minutes. 4. Serve over rice.",
        ),
        ...
        "tags": kwargs.get(
            ...
            frozenset(
                [
                    create_api_recipe_tag(
                        key="speed", value="quick", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="difficulty", value="easy", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="cooking-method", value="stir-fry", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="occasion", value="weeknight", author_id=author_id
                    ),
                ]
            ),
        ),
        "ratings": kwargs.get(
            ...
            frozenset(
                [
                    create_api_rating(
                        taste=4, convenience=5, comment="Perfect for busy nights!"
                    )
                ]
            ),
        ),
...
def create_dessert_api_recipe(**kwargs) -> ApiRecipe:
    ...
    dessert_ingredients = frozenset(
        [
            create_baking_ingredient(
                name="All-Purpose Flour", quantity=2.0, position=0
            ),
            create_api_ingredient(
                name="Sugar", quantity=150.0, unit=MeasureUnit.GRAM, position=1
            ),
            create_api_ingredient(
                name="Dark Chocolate", quantity=200.0, unit=MeasureUnit.GRAM, position=2
            ),
            create_api_ingredient(
                name="Butter", quantity=100.0, unit=MeasureUnit.GRAM, position=3
            ),
            create_api_ingredient(
                name="Eggs", quantity=3.0, unit=MeasureUnit.UNIT, position=4
            ),
            create_api_ingredient(
    ...
    final_kwargs = {
        ...
        "tags": kwargs.get(
            ...
            frozenset(
                [
                    create_api_recipe_tag(
                        key="meal-type", value="dessert", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="mood", value="indulgent", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="cooking-method", value="bake", author_id=author_id
                    ),
                    create_api_recipe_tag(
                        key="occasion", value="treat", author_id=author_id
                    ),
                ]
            ),
        ),
        ...
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["name", "description", "ingredients", "tags", "nutri_facts"]
        },
    }
    return create_api_recipe(**final_kwargs)
...
def create_api_recipe_with_incorrect_averages(**kwargs) -> ApiRecipe:
    ...
    if "ratings" in kwargs:
        ...
        ratings = frozenset(
            [
                create_api_rating(
                    taste=4, convenience=2, comment="Great taste, takes time"
                ),
                create_api_rating(
                    taste=5, convenience=3, comment="Excellent flavor, moderate effort"
                ),
                create_api_rating(
                    taste=3, convenience=4, comment="Good and convenient"
                ),
            ]
        )
    ...
    if ratings:
        ...
        incorrect_taste_avg = max(
            1.0, true_taste_avg - 1.5
        )  # Ensure it stays within valid range
        incorrect_convenience_avg = max(
            1.0, true_convenience_avg - 2.0
        )  # Ensure it stays within valid range
    else:
    ...
    final_kwargs = {
        ...
        "average_convenience_rating": kwargs.get(
            "average_convenience_rating", incorrect_convenience_avg
        ),
        **{
            k: v
            for k, v in kwargs.items()
...
def create_api_recipe_without_ratings(**kwargs) -> ApiRecipe:
    ...
    final_kwargs = {
        ...
        "average_taste_rating": kwargs.get("average_taste_rating"),
        "average_convenience_rating": kwargs.get("average_convenience_rating"),
        **{
            k: v
            for k, v in kwargs.items()
            if k
...
def create_api_recipe_with_max_fields(**kwargs) -> ApiRecipe:
    ...
    max_ingredients = frozenset(
        [create_api_ingredient(position=i) for i in range(50)]
    )  # Assuming max 50 ingredients
    max_ratings = frozenset(
        [create_api_rating() for _ in range(100)]
    )  # Assuming max 100 ratings
    max_tags = frozenset(
        [create_api_recipe_tag(author_id=author_id, post_fix=str(i)) for i in range(20)]
    )  # Assuming max 20 tags
    ...
    for i in range(count):
        ...
        recipe = create_api_recipe(
            ...
            tags=frozenset(
                [
                    create_api_recipe_tag(
                        key="cuisine", value=cuisine, author_id=author_id
                    )
                ]
            ),
        )
...
def create_api_recipes_by_difficulty(
        ...
        if difficulty == "easy":
            ...
            recipe = create_api_recipe(
                ...
                tags=frozenset(
                    [
                        create_api_recipe_tag(
                            key="difficulty", value=difficulty, author_id=author_id
                        )
                    ]
                ),
            )
            ...
            "ingredients": [
                {
                    ...
                    "unit": "g",
                    "position": 0,
                    "full_text": "1 unit of ingredient 1",
                    "product_id": None,
                }
            ],
            "tags": [
            ...
            "ingredients": [
                {
                    ...
                    "unit": "l",
                    "position": i - 1,
                    "full_text": f"{i}g of ingredient {i}",
                ...
                "ingredients": [
                    {
                        ...
                        "unit": "invalid_unit",
                        "position": 0,
                    }  # Fixed: use valid position, invalid quantity/unit
                ],
                "ratings": [
                    {
                        "user_id": "not-a-uuid",
...
def validate_average_rating_correction_roundtrip(
    ...
    if api_recipe.ratings is not None:
        expected_taste_avg = sum(r.taste for r in api_recipe.ratings) / len(
            api_recipe.ratings
        )
        expected_convenience_avg = sum(r.convenience for r in api_recipe.ratings) / len(
            api_recipe.ratings
        )
    else:
    ...
    convenience_corrected = (
        corrected_api_recipe.average_convenience_rating == expected_convenience_avg
    )
...
def create_conversion_performance_dataset_for_api_recipe(
    count: int = 1000,
) -> dict[str, Any]:
...
def create_nested_object_validation_dataset_for_api_recipe(
    count: int = 1000,
) -> list[ApiRecipe]:
    ...
    for i in range(count):
        ...
        ingredients = frozenset(
            [create_api_ingredient(position=j) for j in range(ingredient_count)]
        )
        ratings = frozenset([create_api_rating() for _ in range(rating_count)])
        tags = frozenset(
            [
                create_api_recipe_tag(author_id=author_id, post_fix=str(j))
                for j in range(tag_count)
            ]
        )

        recipe = create_api_recipe(
            author_id=author_id, ingredients=ingredients, ratings=ratings, tags=tags
        )
        recipes.append(recipe)
...
def create_api_recipe_with_invalid_convenience_rating(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        average_convenience_rating=kwargs.get(
            "average_convenience_rating", -1.0
...
def create_api_recipe_with_extreme_boundary_values(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        average_convenience_rating=kwargs.get(
            "average_convenience_rating", 0.0
        ),  # Minimum valid rating
        **{
            k: v
            for k, v in kwargs.items()
...
def create_api_recipe_with_empty_strings(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["description", "utensils", "notes", "image_url"]
        },
    )
...
def create_api_recipe_with_whitespace_strings(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["name", "instructions", "description", "utensils", "notes"]
        },
    )
    ...
    recipe_kwargs["tags"] = [
        {
            ...
            "value": "value",
            "type": "recipe",
        }  # Missing author_id and no context
    ]
...
def create_api_recipe_with_mixed_tag_types(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        tags=kwargs.get(
            ...
            [
                create_api_recipe_tag(
                    author_id=author_id, key="existing", value="tag"
                ),  # Valid ApiTag
                {
                    "key": "dict",
                    "value": "tag",
                    "type": "recipe",
                    "author_id": author_id,
                },  # Valid dict (missing author_id will be added)
            ],
        ),
        **{k: v for k, v in kwargs.items() if k != "tags"},
    )
...
def create_api_recipe_with_set_ingredients(**kwargs) -> dict[str, Any]:
    ...
    ingredients = frozenset(
        [create_api_ingredient(position=i) for i in range(3)]
    )  # Use list since ApiIngredient is not hashable
    return create_api_recipe_kwargs(
        ingredients=kwargs.get("ingredients", ingredients),  # List instead of frozenset
        **{k: v for k, v in kwargs.items() if k != "ingredients"},
    )
...
def create_api_recipe_with_set_ratings(**kwargs) -> dict[str, Any]:
    ...
    ratings = frozenset(
        [create_api_rating() for _ in range(3)]
    )  # Use list since ApiRating is not hashable
    return create_api_recipe_kwargs(
        ratings=kwargs.get("ratings", ratings),  # List instead of frozenset
        **{k: v for k, v in kwargs.items() if k != "ratings"},
    )
...
def create_api_recipe_with_list_tags(**kwargs) -> dict[str, Any]:
    ...
    author_id = kwargs.get("author_id", str(uuid4()))
    tags = frozenset(
        [create_api_recipe_tag(author_id=author_id, post_fix=str(i)) for i in range(3)]
    )
    return create_api_recipe_kwargs(
        author_id=author_id,
...
def create_api_recipe_with_set_tags(**kwargs) -> dict[str, Any]:
    ...
    tags = frozenset(
        [create_api_recipe_tag(author_id=author_id, post_fix=str(i)) for i in range(3)]
    )  # Use list since ApiTag is not hashable
    return create_api_recipe_kwargs(
        author_id=author_id,
        tags=kwargs.get("tags", tags),  # List instead of frozenset
        **{k: v for k, v in kwargs.items() if k != "tags"},
...
def create_api_recipe_with_empty_collections(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["ingredients", "ratings", "tags"]
        },
    )
...
def create_api_recipe_with_mismatched_computed_properties(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        **{
            ...
            for k, v in kwargs.items()
            if k
            not in ["ratings", "average_taste_rating", "average_convenience_rating"]
        },
    )
...
def create_api_recipe_with_unicode_text(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        description=kwargs.get(
            "description",
            "Délicieux pâté français avec des échalotes caramélisées et une touche de cognac. Parfait pour les occasions spéciales! 🇫🇷",
        ),
        instructions=kwargs.get(
            "instructions",
            "1. Nettoyer les échalotes 🧅\n2. Caraméliser à feu doux 🔥\n3. Ajouter le cognac 🍾\n4. Servir avec du pain grillé 🍞",
        ),
        notes=kwargs.get(
            "notes",
            "Conseil: Utiliser des échalotes de qualité supérieure pour un meilleur goût! 👨‍🍳",
        ),
        utensils=kwargs.get(
            "utensils", "Couteau de chef, poêle anti-adhésive, cuillère en bois"
        ),
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["name", "description", "instructions", "notes", "utensils"]
        },
    )
...
def create_api_recipe_with_special_characters(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        instructions=kwargs.get(
            "instructions", "1. Mix & match 2. Heat @ 350°F 3. Serve w/ style!"
        ),
        notes=kwargs.get(
            "notes", "Note: Be careful with temp. measurements (°F vs °C)"
        ),
        **{
            k: v
            for k, v in kwargs.items()
            if k not in ["name", "description", "instructions", "notes"]
        },
    )
...
def create_api_recipe_with_html_characters(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        description=kwargs.get(
            "description",
            "<b>Bold</b> and <i>italic</i> text with <a href='#'>links</a>",
        ),
        instructions=kwargs.get(
            "instructions",
            "1. <strong>Strongly</strong> mix ingredients 2. <em>Emphasize</em> cooking time",
        ),
...
def create_api_recipe_with_sql_injection(**kwargs) -> dict[str, Any]:
    ...
    return create_api_recipe_kwargs(
        ...
        instructions=kwargs.get(
            "instructions",
            "1. SELECT * FROM ingredients WHERE name = 'test' OR 1=1; --",
        ),
...
def create_comprehensive_validation_test_cases_for_api_recipe() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {
            "factory": create_api_recipe_with_invalid_instructions,
            "expected_error": "instructions",
        },  # 1
        {
            "factory": create_api_recipe_with_invalid_total_time,
            "expected_error": "total_time",
        },  # 2
        {
            "factory": create_api_recipe_with_invalid_weight,
            "expected_error": "weight_in_grams",
        },  # 3
        {
            "factory": create_api_recipe_with_invalid_privacy,
            "expected_error": "privacy",
        },  # 4
        # Boundary cases
        {
            "factory": create_api_recipe_with_boundary_values,
            "expected_error": None,
        },  # 5
        {
            "factory": create_api_recipe_with_extreme_boundary_values,
            "expected_error": None,
        },  # 6
        {
            "factory": create_api_recipe_with_none_values,
            "expected_error": "name, instructions, meal_id",
        },  # 7
        {"factory": create_api_recipe_with_empty_strings, "expected_error": None},  # 8
        # Tags validation edge cases
        {
            "factory": create_api_recipe_with_invalid_tag_dict,
            "expected_error": "tags",
        },  # 9
        {
            "factory": create_api_recipe_with_invalid_tag_types,
            "expected_error": "tags",
        },  # 10
        {
            "factory": create_api_recipe_with_tag_without_author_id_context,
            "expected_error": "tags",
        },  # 11
        {
            "factory": create_api_recipe_with_mixed_tag_types,
            "expected_error": None,
        },  # 12
        # Collection type edge cases
        {
            "factory": create_api_recipe_with_list_ingredients,
            "expected_error": None,
        },  # 13
        {
            "factory": create_api_recipe_with_set_ingredients,
            "expected_error": None,
        },  # 14
        ...
        {
            "factory": create_api_recipe_with_empty_collections,
            "expected_error": None,
        },  # 19
        # Computed properties edge cases
        {
            "factory": create_api_recipe_with_mismatched_computed_properties,
            "expected_error": None,
        },  # 20
        {"factory": create_api_recipe_with_single_rating, "expected_error": None},  # 21
        {
            "factory": create_api_recipe_with_extreme_ratings,
            "expected_error": None,
        },  # 22
        {
            "factory": create_api_recipe_with_fractional_averages,
            "expected_error": None,
        },  # 23
        # Datetime edge cases
        {
            "factory": create_api_recipe_with_future_timestamps,
            "expected_error": None,
        },  # 24
        {
            "factory": create_api_recipe_with_past_timestamps,
            "expected_error": None,
        },  # 25
        {
            "factory": create_api_recipe_with_invalid_timestamp_order,
            "expected_error": None,
        },  # 26
        {
            "factory": create_api_recipe_with_same_timestamps,
            "expected_error": None,
        },  # 27
        # Text edge cases
        {"factory": create_api_recipe_with_unicode_text, "expected_error": None},  # 28
        {
            "factory": create_api_recipe_with_special_characters,
            "expected_error": None,
        },  # 29
        {
            "factory": create_api_recipe_with_html_characters,
            "expected_error": None,
        },  # 30
        {"factory": create_api_recipe_with_sql_injection, "expected_error": None},  # 31
        {
            "factory": create_api_recipe_with_very_long_text,
            "expected_error": "validation",
        },  # 32
        # Concurrency edge cases
        {
            "factory": create_api_recipe_with_concurrent_modifications,
            "expected_error": None,
        },  # 33
...
def validate_round_trip_conversion_for_api_recipe(
    api_recipe: ApiRecipe,
) -> dict[str, Any]:
    """
    ...
    try:
        ...
        computed_check = _validate_computed_properties_correction(
            api_recipe, converted_api_recipe
        )
        results["computed_properties_corrected"] = computed_check["corrected"]
        results["warnings"].extend(computed_check["warnings"])

    except Exception as e:
        results["errors"].append(f"Conversion failed: {e!s}")

    return results


def _validate_data_integrity(
    original: ApiRecipe, converted: ApiRecipe
) -> dict[str, Any]:
    ...
    return {"maintained": len(warnings) == 0, "warnings": warnings}


def _validate_computed_properties_correction(
    original: ApiRecipe, converted: ApiRecipe
) -> dict[str, Any]:
    ...
    if original.ratings:
        ...
        expected_convenience = sum(r.convenience for r in original.ratings) / len(
            original.ratings
        )
        ...
        if converted.average_taste_rating != expected_taste:
            warnings.append(
                f"Taste average not corrected: expected {expected_taste}, got {converted.average_taste_rating}"
            )
        if converted.average_convenience_rating != expected_convenience:
            warnings.append(
                f"Convenience average not corrected: expected {expected_convenience}, got {converted.average_convenience_rating}"
            )

    return {"corrected": len(warnings) == 0, "warnings": warnings}
...
def validate_orm_conversion_for_api_recipe(api_recipe: ApiRecipe) -> dict[str, Any]:
    ...
    try:
        ...
        results["errors"].append(f"ORM conversion failed: {e!s}")
...
def validate_json_serialization_of_api_recipe(api_recipe: ApiRecipe) -> dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            results["errors"].append(f"Invalid JSON generated: {e!s}")
            return results
        ...
        results["errors"].append(f"JSON serialization failed: {e!s}")
...
def create_api_recipe_with_massive_collections(**kwargs) -> dict[str, Any]:
    ...
    massive_ingredients = frozenset(
        [create_api_ingredient(position=i) for i in range(100)]
    )
    massive_ratings = frozenset([create_api_rating() for _ in range(1000)])
    massive_tags = frozenset(
        [
            create_api_recipe_tag(author_id=author_id, post_fix=str(i))
            for i in range(100)
        ]
    )
...
def create_stress_test_dataset_for_api_recipe(
    count: int = 10000,
) -> list[dict[str, Any]]:
