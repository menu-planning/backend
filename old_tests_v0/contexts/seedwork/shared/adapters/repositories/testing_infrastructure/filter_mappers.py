...
from src.contexts.seedwork.adapters.repositories.seedwork_repository import (
    FilterColumnMapper,
)
...
TEST_EDGE_CASE_FILTER_MAPPERS: list[FilterColumnMapper] = [
    ...
    FilterColumnMapper(
        ...
        join_target_and_on_clause=[
            (SelfReferentialTestModel, SelfReferentialTestModel.parent)
        ],
    ),
    ...
    FilterColumnMapper(
        ...
        join_target_and_on_clause=[
            (SelfReferentialTestModel, SelfReferentialTestModel.friends)
        ],
    ),
]
