...
from old_tests_v0.contexts.iam.core.adapters.repositories.user_data_factories import (
...
# Load integration database fixtures - moved to top-level conftest
...
async def role_specific_users(test_session: AsyncSession):
    ...
    multi_context_user = create_user_orm(
        ...
        roles=[
            ...
            create_role_orm(
                name="auditor", context="recipes_catalog", permissions="read, audit"
            ),
        ],
    )
