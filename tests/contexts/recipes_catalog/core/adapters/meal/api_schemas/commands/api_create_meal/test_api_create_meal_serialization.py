...
class TestApiCreateMealComplexSerialization:
    ...
    def test_serialization_with_all_fields_populated(self):
        ...
        kwargs = create_api_create_meal_kwargs(
            ...
            recipes=recipes,
            tags=frozenset([
                create_api_meal_tag(key='occasion', value='holiday', author_id=author_id),
                create_api_meal_tag(key='difficulty', value='challenging', author_id=author_id),
    ...
    def test_serialization_with_unicode_characters(self):
        ...
        assert recreated_meal.description is not None and "naïve" in recreated_meal.description
        assert recreated_meal.notes is not None and "café" in recreated_meal.notes and "🔥" in recreated_meal.notes
    ...
    def test_serialization_with_large_datasets(self):
        ...
        json_str = meal.model_dump_json()
        assert json_str is not None
        assert len(json_str) > 2000  # Should be a substantial JSON string for complex meal
...
class TestApiCreateMealSerializationFormat:
    ...
    def test_json_nested_objects_structure(self):
        ...
        tags = frozenset([create_api_meal_tag(key='test', value='value', author_id=author_id)])
...
class TestApiCreateMealRoundTripSerialization:
    ...
    def test_round_trip_preserves_complex_objects(self):
        ...
        tags = frozenset([
            create_api_meal_tag(key='complex-key', value='complex-value', author_id=author_id),
        ])
    ...
    def test_round_trip_with_meal_specific_complexity(self):
        ...
        for orig_recipe, recreated_recipe in zip(original_meal.recipes, recreated_meal.recipes):
            ...
            if orig_recipe.ingredients is not None and recreated_recipe.ingredients is not None:
