...
def create_api_nutri_facts(**kwargs) -> ApiNutriFacts:
    ...
    nutrition_profiles = [
        # Italian dinner meal
        {"calories": 1800.0, "protein": 65.0, "carbohydrate": 180.0, "total_fat": 95.0, "sodium": 2400.0},
        # Healthy Mediterranean lunch
        {"calories": 650.0, "protein": 28.0, "carbohydrate": 75.0, "total_fat": 25.0, "sodium": 850.0},
        # Comfort brunch
        {"calories": 2200.0, "protein": 85.0, "carbohydrate": 220.0, "total_fat": 120.0, "sodium": 3200.0},
        # Asian fusion dinner
        {"calories": 1400.0, "protein": 55.0, "carbohydrate": 140.0, "total_fat": 75.0, "sodium": 2800.0},
        # Light summer picnic
        {"calories": 800.0, "protein": 32.0, "carbohydrate": 85.0, "total_fat": 35.0, "sodium": 1200.0},
        # Family Sunday dinner
        {"calories": 2500.0, "protein": 95.0, "carbohydrate": 275.0, "total_fat": 135.0, "sodium": 4000.0},
        # Vegan power bowl
        {"calories": 900.0, "protein": 42.0, "carbohydrate": 120.0, "total_fat": 28.0, "sodium": 900.0},
        # Quick weeknight dinner
        {"calories": 1200.0, "protein": 48.0, "carbohydrate": 125.0, "total_fat": 55.0, "sodium": 1800.0},
        # Holiday feast
        {"calories": 3000.0, "protein": 125.0, "carbohydrate": 350.0, "total_fat": 165.0, "sodium": 5000.0},
...
def create_api_meal_with_invalid_field(field_name: str, invalid_value: Any, **kwargs) -> Dict[str, Any]:
    """
...
def create_api_meal_with_missing_required_fields() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {k: v for k, v in base_kwargs.items() if k != "created_at"},    # Missing created_at
        {k: v for k, v in base_kwargs.items() if k != "updated_at"},    # Missing updated_at
        ...
        {k: v for k, v in base_kwargs.items() if k not in ["id", "created_at", "updated_at"]},
    ]
...
def create_nested_object_validation_test_cases() -> Dict[str, List[Dict[str, Any]]]:
    ...
    return {
        "invalid_recipes": [
            ...
            {"recipes": [{"name": "Test", "author_id": "not-uuid"}]},  # Invalid author UUID
            {"recipes": [{"name": 123, "author_id": str(uuid4())}]},  # Wrong type for name
...
def create_comprehensive_validation_error_scenarios() -> Dict[str, Any]:
    ...
    return {
        "missing_required_fields": [
            {
                "name": "missing_name",
                "data": {k: v for k, v in create_api_meal_kwargs().items() if k != "name"},
                "expected_errors": ["name"],
                "error_type": "missing_required_field"
            },
            {
                "name": "missing_author_id",
                "data": {k: v for k, v in create_api_meal_kwargs().items() if k != "author_id"},
                "expected_errors": ["author_id"],
                "error_type": "missing_required_field"
            },
            {
                "name": "missing_multiple_fields",
                "data": {k: v for k, v in create_api_meal_kwargs().items() if k not in ["name", "author_id"]},
        ...
        "invalid_field_types": [
            ...
            },
            {
                ...
                "data": create_api_meal_with_invalid_field("weight_in_grams", "not_int"),
        ...
        "nested_object_errors": [
            {
                ...
                "data": create_api_meal_with_invalid_field("recipes", [{"name": "Invalid"}]),
...
def create_pydantic_config_test_cases() -> Dict[str[str, Any]]:
    ...
    return {
        "extra_fields_forbidden": {
            ...
            "expected_errors": ["extra_field", "unknown_property", "malicious_field", "api_key"]
        },
        "strict_type_validation": {
            ...
            "expected_errors": ["weight_in_grams", "like", "version", "carbo_percentage", "discarded"]
        },
        "assignment_validation": {
            ...
            "invalid_assignments": [
                ...
                ("carbo_percentage", 101.0),    # Invalid percentage (violates constraints)
            ...
            "expected_errors": ["name", "weight_in_grams", "carbo_percentage", "author_id", "version", "recipes", "tags"]
        },
        "frozen_immutability": {
            ...
            "expected_errors": ["name", "like", "weight_in_grams", "carbo_percentage", "version", "discarded", "author_id"]
        }
    }
...
def create_api_meal_with_type_coercion_scenarios(**kwargs) -> Dict[str, Any]:
    ...
    """
    return {
        **{k: v for k, v in create_api_meal_kwargs(**kwargs).items() if k not in [
            "weight_in_grams", "like", "version", "carbo_percentage", "discarded", "name"
        ]},
...
def create_api_meal_kwargs(**kwargs) -> Dict[str, Any]:
    ...
    protein_percentage = (total_protein / total_macros) * 100 if total_macros > 0 else None
    ...
    final_kwargs = {
        ...
        "total_fat_percentage": kwargs.get("total_fat_percentage", total_fat_percentage),
...
def create_api_meal_with_incorrect_computed_properties(**kwargs) -> ApiMeal:
    ...
    final_kwargs = {
        ...
        "weight_in_grams": kwargs.get("weight_in_grams", 300),  # Incorrect - should be sum of recipe weights
        "calorie_density": kwargs.get("calorie_density", 100.0),  # Incorrect - should be calculated
...
def create_json_serialization_test_cases() -> Dict[str, Any]:
    ...
    return {
        ...
        "complex_meal_json": {
            ...
            "expected_patterns": [
                '"name":', '"description":', '"notes":', '"like":',
                '"image_url":', '"nutri_facts":', '"weight_in_grams":',
                '"calorie_density":', '"carbo_percentage":', '"protein_percentage":'
            ]
        },
        "meal_with_nulls_json": {
            ...
            "expected_patterns": [
                '"description": null', '"notes": null', '"like": null',
                '"image_url": null', '"nutri_facts": null', '"menu_id": null'
            ]
        },
        ...
        "meal_with_computed_properties_json": {
            ...
            "expected_patterns": [
                '"calorie_density":', '"carbo_percentage":', '"protein_percentage":',
                '"total_fat_percentage":', '"weight_in_grams":'
            ]
        }
    }
...
def create_json_deserialization_test_cases() -> Dict[str, Any]:
    ...
    return {
        "valid_json_strings": {
            ...
            "json_with_nested_objects": json.dumps(_convert_to_json_serializable(create_api_meal_kwargs())),
        },
    ...
    return {
        "domain_to_api_conversion": {
            "simple_domain_meal": {
                ...
                "validation": ["id", "name", "author_id", "recipes", "tags", "created_at", "updated_at"]
            },
            "complex_domain_meal": {
                "description": "Convert complex domain meal with all fields",
                "setup": lambda: create_complex_api_meal().to_domain(),
                "test": lambda domain_meal: ApiMeal.from_domain(domain_meal),
                "validation": ["description", "notes", "like", "image_url", "nutri_facts", "weight_in_grams"]
            },
            "domain_meal_with_computed_properties": {
                ...
                "test": lambda domain_meal: ApiMeal.from_domain(domain_meal),
                "validation": ["calorie_density", "carbo_percentage", "protein_percentage", "total_fat_percentage"]
            }
        },
        "api_to_domain_conversion": {
            ...
            "api_meal_with_nulls": {
                ...
                "test": lambda api_meal: api_meal.to_domain(),
                "validation": ["description", "notes", "like", "image_url", "nutri_facts", "menu_id"]
            }
        },
    ...
    return {
        ...
        "computed_property_conversions": {
            "api_meal_with_computed_props": {
                "meal": create_api_meal_with_incorrect_computed_properties(),
                "computed_fields": ["calorie_density", "carbo_percentage", "protein_percentage", "total_fat_percentage"],
                "test_conversions": [
    ...
    return [
        ...
        # Invalid nested objects
        {
            "data": {
                ...
                "author_id": str(uuid4()),
                "recipes": [
                    {"name": "Invalid Recipe", "instructions": "test"}  # Missing required fields
                ],
                "tags": [
...
def validate_computed_property_correction_roundtrip(api_meal: ApiMeal) -> tuple[bool[str, Any]]:
    ...
    if api_meal.recipes:        
        ...
        # Aggregate weight
        expected_weight = sum(r.weight_in_grams if r.weight_in_grams else 0 for r in api_meal.recipes)
    ...
    if expected_calorie_density and corrected_api_meal.calorie_density:
        calorie_density_corrected = abs(corrected_api_meal.calorie_density - expected_calorie_density) < 0.1
    
    details = {
        "original_nutri_facts": api_meal.nutri_facts.model_dump() if api_meal.nutri_facts else None,
        "corrected_nutri_facts": corrected_api_meal.nutri_facts.model_dump() if corrected_api_meal.nutri_facts else None,
    ...
    return (nutri_facts_corrected and weight_corrected and calorie_density_corrected), details
    ...
    return {
        "maximum_field_lengths": {
            ...
            "max_description_length": {
                "meal": create_api_meal(description="Lorem ipsum dolor sit amet. " * 1000),
        ...
        "maximum_collection_sizes": {
            ...
            "max_tags": {
                "meal": create_api_meal(tags=frozenset([create_api_tag() for _ in range(50)])),
        ...
        "memory_intensive_scenarios": {
            "large_nutri_facts": {
                "meal": create_api_meal(nutri_facts=create_api_nutri_facts(
                    calories=999999.99,
                    protein=999999.99,
...
def create_validation_performance_scenarios() -> Dict[str, Any]:
    ...
    return {
        ...
        "nested_validation_performance": {
            "recipe_validation": {
                "data": [
                    create_api_meal_with_invalid_field("recipes", [
            ...
            "tag_validation": {
                "data": [
                    create_api_meal_with_invalid_field("tags", [
        ...
        "bulk_validation_performance": {
            ...
            "bulk_invalid_meals": {
                "data": [create_api_meal_with_invalid_field("name", "") for _ in range(10000)],
                "description": "Test bulk validation of invalid meals"
            },
            "mixed_validation": {
                "data": [
                    create_api_meal_kwargs() if i % 2 == 0 
...
def create_serialization_performance_scenarios() -> Dict[str, Any]:
    ...
    return {
        ...
        "json_deserialization_performance": {
            "simple_json": {
                "json_strings": [
                    create_simple_api_meal().model_dump_json()
            ...
            "complex_json": {
                "json_strings": [
                    create_complex_api_meal().model_dump_json()
                    for _ in range(1000)
                ],
            ...
            "large_json": {
                "json_strings": [
                    create_api_meal(
                        description="Large description: " + "Lorem ipsum dolor sit amet. " * 1000,
...
def create_systematic_error_scenarios() -> Dict[str, Any]:
    ...
    return {
        ...
        "type_errors": {
            ...
            "wrong_collection_types": {
                "scenarios": [
                    ...
                    create_api_meal_with_invalid_field("tags", ["list", "not", "frozenset"]),
                ],
                "error_type": "type_error",
            ...
            "wrong_object_types": {
                "scenarios": [
                    ...
                    create_api_meal_with_invalid_field("nutri_facts", ["not", "object"]),
                ],
                "error_type": "type_error",
        ...
        "nested_object_errors": {
            "invalid_recipes": {
                "scenarios": create_nested_object_validation_test_cases()["invalid_recipes"],
                "error_type": "nested_object_error",
            ...
            "invalid_tags": {
                "scenarios": create_nested_object_validation_test_cases()["invalid_tags"],
                "error_type": "nested_object_error",
            ...
            "invalid_nutri_facts": {
                "scenarios": create_nested_object_validation_test_cases()["invalid_nutri_facts"],
                "error_type": "nested_object_error",
...
def create_error_recovery_scenarios() -> Dict[str, Any]:
    ...
    return {
        "partial_data_recovery": {
            ...
            "nested_object_partial_errors": {
                "scenarios": [
                    ...
                    create_api_meal_with_invalid_field("nutri_facts", {"calories": "not_number"}),
                    create_api_meal_with_invalid_field("recipes", [{"name": "Valid"}, {"name": 123}]),
                    create_api_meal_with_invalid_field("tags", [{"key": "valid", "value": "valid"}, {"key": 123}]),
                ],
        ...
        "error_message_quality": {
            ...
            "error_context": {
                "scenarios": [
                    create_api_meal_with_invalid_field("recipes", [{"name": "Invalid"}]),
    ...
    return {
        "boundary_condition_errors": {
            "exact_boundary_violations": {
                "scenarios": [
                    create_api_meal_with_invalid_field("name", "x" * 256),  # Exactly 1 char too long
                    create_api_meal_with_invalid_field("carbo_percentage", 100.0000001),  # Slightly over 100%
                    create_api_meal_with_invalid_field("weight_in_grams", -0.1),  # Slightly negative
                    create_api_meal_with_invalid_field("version", 0.9),  # Just under minimum
                ],
                "description": "Test exact boundary violations"
            },
            "floating_point_precision": {
                "scenarios": [
                    create_api_meal_with_invalid_field("carbo_percentage", 100.0000000000001),
                    create_api_meal_with_invalid_field("calorie_density", -0.0000000000001),
                    create_api_meal_with_invalid_field("protein_percentage", float('inf')),
                    create_api_meal_with_invalid_field("total_fat_percentage", float('nan')),
                ],
        ...
        "extreme_value_errors": {
            "maximum_values": {
                "scenarios": [
                    create_api_meal_with_invalid_field("weight_in_grams", 2**31),  # Max int32 + 1
                    create_api_meal_with_invalid_field("version", 2**63),  # Max int64
                    create_api_meal_with_invalid_field("calorie_density", 1e308),  # Near max float
                ],
                "description": "Test maximum value handling"
            },
            "minimum_values": {
                "scenarios": [
                    create_api_meal_with_invalid_field("weight_in_grams", -2**31),  # Min int32 - 1
                    create_api_meal_with_invalid_field("version", -2**63),  # Min int64
                    create_api_meal_with_invalid_field("calorie_density", -1e308),  # Near min float
                ],
        ...
        "unusual_input_patterns": {
            "control_characters": {
                "scenarios": [
                    create_api_meal_with_invalid_field("name", "Test\x00Meal"),  # Null bytes
                    create_api_meal_with_invalid_field("description", "Test\x1bMeal"),  # Escape chars
                    create_api_meal_with_invalid_field("notes", "Test\x08Meal"),  # Backspace
                ],
                "description": "Test control character handling"
            },
            "unicode_edge_cases": {
                "scenarios": [
                    create_api_meal_with_invalid_field("name", "Test\U0010FFFF"),  # Max Unicode
                    create_api_meal_with_invalid_field("description", "Test\uFFFE"),  # Non-character
                    create_api_meal_with_invalid_field("notes", "Test\uD800"),  # Surrogate
                ],
        ...
        "resource_exhaustion_scenarios": {
            "memory_intensive": {
                "scenarios": [
                    create_api_meal_with_invalid_field("name", "x" * 10000000),  # 10MB string
                    create_api_meal_with_invalid_field("description", "Lorem ipsum. " * 1000000),  # Large text
                ],
