...
class FakeTypeFormAPI:
    ...
    def create_webhook(self, form_id: str, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if "404" in str(e):
                ...
                # If simulate_errors=True and it's a validation error scenario, create form anyway to test validation
                elif not webhook_data.get("url"):
                    counter = get_next_typeform_api_counter()
                    self._forms[form_id] = {
                        "id": form_id,
                        "title": f"Test Onboarding Form {counter}",
        ...
        self._webhooks[form_id] = [w for w in self._webhooks[form_id] if w.get("tag") != tag]
    ...
    def update_webhook(self, form_id: str, webhook_tag: str, webhook_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        existing_webhook["updated_at"] = datetime.now(timezone.utc).isoformat()
    ...
    def add_fake_response(self, form_id: str, response_data: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
