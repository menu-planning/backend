...
class TestApiSchemaError:
    ...
    def test_initialization_with_extra_data(self):
        ...
        error = ApiSchemaError(
            "Test error", custom_field="custom_value", another_field=42
        )

        assert error.extra_data == {"custom_field": "custom_value", "another_field": 42}
...
class TestFieldMappingError:
    ...
    def test_full_initialization(self):
        ...
        type_mismatches = {"id": ("str", "UUID"), "count": ("str", "int")}
