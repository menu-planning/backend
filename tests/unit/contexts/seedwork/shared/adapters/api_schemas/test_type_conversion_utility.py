...
class TestTypeConversionUtility:
    ...
    def setup_method(self):
        ...
        self.test_datetime = datetime(2024, 1, 15, 10, 30, 45, 123456, UTC)
    ...
    def test_uuid_conversion_performance(self):
        ...
        assert (
            uuid_to_string_time < 0.01
        ), f"UUID to string conversion too slow: {uuid_to_string_time:.4f}s"
        assert (
            string_to_uuid_time < 0.01
        ), f"String to UUID conversion too slow: {string_to_uuid_time:.4f}s"
    ...
    def test_collection_conversion_performance(self):
        ...
        assert (
            collection_time < 0.005
        ), f"Collection conversion too slow: {collection_time:.4f}s"
    ...
    def test_round_trip_conversions(self):
        ...
        # DateTime round-trip
        original_datetime = datetime.now(UTC)
