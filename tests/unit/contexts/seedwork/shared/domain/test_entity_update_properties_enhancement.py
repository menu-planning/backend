...
class MockStandardEntity(Entity):
...
class MockEntityWithHooks(Entity):
...
class MockEntityWithProtectedSetters(Entity):
...
class TestEnhancedEntityUpdateProperties:
    ...
    def test_standard_entity_update_properties_flow(self):
        ...
        entity = MockStandardEntity("test-id", "original", "original_desc")
    ...
    def test_entity_with_post_update_hooks(self):
        ...
        entity = MockEntityWithHooks("test-id", "original")
    ...
    def test_entity_with_protected_setters(self):
        ...
        entity = MockEntityWithProtectedSetters("test-id", "original", "original_desc")
    ...
    def test_entity_validates_private_properties(self):
        ...
        entity = MockStandardEntity("test-id")
    ...
    def test_entity_invalidates_all_caches_after_update(self):
        ...
        entity = MockStandardEntity("test-id", "original")
