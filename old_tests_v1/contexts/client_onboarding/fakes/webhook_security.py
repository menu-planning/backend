...
class WebhookSecurityHelper:
    ...
    def create_valid_headers_for_json_payload(
        self, payload_str: str, **kwargs
    ) -> dict[str, str]:
        """
    ...
    def create_invalid_headers(
        self, payload: dict[str, Any], signature_type: str = "invalid_secret", **kwargs
    ) -> dict[str, str]:
        """
    ...
    def create_missing_signature_headers(
...
def create_valid_webhook_security_scenario(**kwargs) -> dict[str, Any]:
    ...
    if "form_response" in payload_overrides:
        ...
        payload_kwargs = {
            k: v for k, v in payload_overrides.items() if k != "form_response"
        }
...
def create_invalid_webhook_security_scenario(
    signature_type: str = "invalid_secret", **kwargs
) -> dict[str, Any]:
    """
...
def create_multiple_security_scenarios(**kwargs) -> dict[str[str, Any]]:
    ...
    scenarios = {
        ...
        "invalid_secret": create_invalid_webhook_security_scenario(
            "invalid_secret", **kwargs
        ),
        "malformed_signature": create_invalid_webhook_security_scenario(
            "malformed", **kwargs
        ),
        "wrong_algorithm": create_invalid_webhook_security_scenario(
            "wrong_algorithm", **kwargs
        ),
        "empty_signature": create_invalid_webhook_security_scenario("empty", **kwargs),
        "missing_signature": create_invalid_webhook_security_scenario(
            "missing", **kwargs
        ),
    }
