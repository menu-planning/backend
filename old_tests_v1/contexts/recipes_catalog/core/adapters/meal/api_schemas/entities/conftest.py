...
def simple_recipe():
    ...
    return ApiRecipe(
        ...
        nutri_facts=create_api_nutri_facts(
            calories=250.0, protein=6.0, carbohydrate=30.0, total_fat=12.0, sodium=400.0
        ),
        weight_in_grams=80,
        image_url=None,
...
def complex_recipe():
    ...
    tags = frozenset(
        [
            ApiTag(
                key="category", value="beef", author_id=recipe_author_id, type="recipe"
            ),
            ApiTag(
                key="style",
                value="fine-dining",
            ...
            ApiTag(
                key="cuisine", value="french", author_id=recipe_author_id, type="recipe"
            ),
            ApiTag(
                key="technique",
                value="pastry",
