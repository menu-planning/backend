...
class TestApiCreateMealAuthorIdFieldValidation:
    ...
    def test_author_id_field_validation_using_data_factories(self):
        ...
        kwargs = create_minimal_api_create_meal_with_author_id(
...
class TestApiCreateMealOptionalFieldValidation:
    ...
    def test_description_field_validation_max_length(self):
        ...
        very_long_description = (
            "A" * 1001
        )  # Over max length (1000 chars based on field definition)
    ...
    def test_description_field_validation_max_length_boundary(self):
        ...
        boundary_description = (
            "A" * 1000
        )  # Max length from MealDescriptionOptional field
...
class TestApiCreateMealComplexFieldValidation:
    ...
    def test_recipes_field_validation_single_recipe(self):
        ...
        single_recipe = [
            create_simple_api_recipe(
                name="Pasta Recipe", author_id=author_id, meal_id=meal_id
            )
        ]
        kwargs = create_minimal_api_create_meal_kwargs(
    ...
    def test_recipes_field_validation_multiple_recipes(self):
        ...
        multiple_recipes = [
            ...
            create_simple_api_recipe(
                name="Side Dish", author_id=author_id, meal_id=meal_id
            ),
            create_simple_api_recipe(
                name="Dessert", author_id=author_id, meal_id=meal_id
            ),
        ]
        kwargs = create_minimal_api_create_meal_kwargs(
    ...
    def test_tags_field_validation_multiple_tags(self):
        ...
        multiple_tags = frozenset(
            [
                ...
                create_api_meal_tag(
                    key="difficulty", value="medium", author_id=author_id
                ),
            ]
        )
        kwargs = create_minimal_api_create_meal_kwargs(
    ...
    def test_tags_field_validation_author_id_mismatch(self):
        ...
        mismatched_tag = frozenset(
            [
                create_api_meal_tag(
                    key="meal_type", value="dinner", author_id=different_author_id
                )
            ]
        )
        kwargs = create_minimal_api_create_meal_kwargs(
            author_id=meal_author_id, tags=mismatched_tag
        )
    ...
    def test_complex_meal_validation_comprehensive(self):
        ...
        recipes = [
            create_simple_api_recipe(
                name="Salad", author_id=author_id, meal_id=meal_id
            ),
            create_complex_api_recipe(
                name="Main Dish", author_id=author_id, meal_id=meal_id
            ),
        ]
        ...
        tags = frozenset(
            [
                create_api_meal_tag(
                    key="meal_type", value="lunch", author_id=author_id
                ),
