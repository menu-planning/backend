...
class TestApiUpdateRecipeErrorHandling:
    ...
    def test_conversion_failure_with_systematic_error_scenarios_manual(
    ...
    def test_invalid_input_handling_comprehensive_manual(
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            },  # Null character in description
            {
                "name": "test",
                "instructions": "test\x00",
            },  # Null character in instructions
            # Boundary values
    ...
    def test_comprehensive_validation_error_scenarios_manual(
        self, scenario_name, scenario_data
    ):
    ...
    def test_malformed_uuid_handling(self):
        ...
        with pytest.raises(ValidationError):
            ApiUpdateRecipe(recipe_id="not-a-uuid", updates=valid_updates)
    ...
    def test_partial_updates_with_single_field(self):
        ...
        update_recipe = ApiUpdateRecipe(
            recipe_id=base_recipe.id, updates=modified_updates
        )
