    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            {"field": "total_time", "value": "invalid", "error_contains": "total_time"},
            {
                ...
                "value": -1,
                "error_contains": "weight_in_grams",
            },
            {
                "field": "weight_in_grams",
                "value": "invalid",
...
class TestApiCreateRecipeComplexScenarios:
    ...
    @pytest.mark.parametrize(
        "validation_case", create_comprehensive_validation_test_cases_for_api_recipe()
    )
    ...
    def test_comprehensive_field_validation_matrix(
        self, name, instructions, author_id, meal_id
    ):
        """Test comprehensive field validation matrix covering all combinations."""
        kwargs = create_api_create_recipe_kwargs(
            name=name, instructions=instructions, author_id=author_id, meal_id=meal_id
        )
            ...
            if "tags" in scenario_copy:
                ...
                for tag in scenario_tags:
                    ...
                    tag = create_api_recipe_tag(
                        key=key, value=value, author_id=author_id
                    )
                    tags.append(tag)
            tags = frozenset(tags)
