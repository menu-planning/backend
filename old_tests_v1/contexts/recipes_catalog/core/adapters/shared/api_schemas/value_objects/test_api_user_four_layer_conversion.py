...
class TestApiUserFourLayerConversion:
    ...
    def test_from_orm_model_conversion_preserves_all_data(self):
        ...
        mock_orm.roles = [
            {
                "name": "administrator_role",
                "permissions": "manage_users, manage_recipes, manage_meals, view_audit_log",
            },
            {
                "name": "user_role",
                "permissions": "access_basic_features, manage_recipes",
            },
        ]
            ...
            roles=frozenset(
                [
                    Role(
                        name="recipe_manager",
                        permissions=frozenset(
                            ["manage_recipes", "access_basic_features"]
                        ),
                    ),
                    Role(
            ...
            roles=frozenset(
                [
                    ...
                    Role(
                        name="premium_user",
                        permissions=frozenset(
                            ["access_basic_features", "access_support"]
                        ),
                    ),
                ]
            ),
