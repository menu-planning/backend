...
PGPASSWORD=development psql -h localhost -p 54321 -U user-dev -d appdb-dev -c "SET session_replication_role = replica;"
PGPASSWORD=development psql -h localhost -p 54321 -U user-dev -d appdb-dev -f data.sql
PGPASSWORD=development psql -h localhost -p 54321 -U user-dev -d appdb-dev -c "SET session_replication_role = DEFAULT;"
