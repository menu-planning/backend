...
class ApiCreateFoodGroup(ApiCreateTag):
    ...
    Attributes:
        ...
        author (ApiUser): The user adding the category.
        description (str, optional): Detailed description of the category.

    Methods:
        to_domain() -> CreateFoodGroup:
    ...
    def to_domain(self) -> CreateFoodGroup:
        """Converts the instance to a domain model object for adding a category."""
        return super().to_domain(CreateFoodGroup)
