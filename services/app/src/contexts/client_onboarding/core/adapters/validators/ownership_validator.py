...
class FormOwnershipValidator:
    ...
    async def _validate_by_onboarding_form_id(
        ...
        if request.onboarding_form_id is None:
            raise ValueError("onboarding_form_id is required for this validation")
        ...
        async with uow:
            ...
            if not onboarding_form:
                ...
                raise FormNotFoundError(
                    f"Onboarding form {request.onboarding_form_id} not found"
                )
            ...
            if onboarding_form.user_id != request.user_id:
                ...
                raise FormAccessDeniedError(
                    f"User {request.user_id} does not own form {request.onboarding_form_id}"
                )
    ...
    async def _validate_by_typeform_id(
        ...
        if request.form_id is None:
            raise ValueError("form_id is required for this validation")
        ...
        async with uow:
            ...
            if not onboarding_form:
                ...
                raise FormNotFoundError(
                    f"Form with TypeForm ID {request.form_id} not found"
                )
