...
from src.contexts.seedwork.shared.adapters.api_schemas.base_api_model import BaseApiCommand, MODEL_CONFIG
...
class ApiSetupOnboardingForm(BaseApiCommand[SetupOnboardingFormCommand]):
    ...
    form_title: Optional[str] = Field(
        default=None, max_length=200, description="Optional custom title (not persisted)"
    )
