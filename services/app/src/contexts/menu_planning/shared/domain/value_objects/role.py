...
from src.contexts.menu_planning.shared.domain.enums import Role as EnumRoles
...
class Role(SeedRole):
    ...
    @classmethod
    def client_manager(cls) -> Role:
        return Role(
            name=EnumRoles.CLIENT_MANAGER.name.lower(),
            permissions=EnumRoles.CLIENT_MANAGER.permissions,
        )
