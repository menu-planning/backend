...
class ProfileDataExtractor:
    ...
    def extract_profile_from_form_response(self, form_response: Dict[str, Any]) -> Optional[Profile]:
        """
    ...
    def _extract_name(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _extract_age(self, extracted_data: Dict[str, Any]) -> Optional[int]:
        """
    ...
    def _extract_birthday(self, extracted_data: Dict[str, Any], age: Optional[int]) -> 'date':
        """
    ...
    def _extract_dietary_preferences(self, extracted_data: Dict[str, Any]) -> Optional[list[str]]:
        """
