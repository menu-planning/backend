...
class AddressDataExtractor:
    ...
    def extract_address_from_form_response(self, form_response: Dict[str, Any]) -> Optional[Address]:
        """
    ...
    def _extract_street(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _extract_city(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _extract_state(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _extract_country(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _extract_zip_code(self, extracted_data: Dict[str, Any]) -> Optional[str]:
        """
    ...
    def _map_state_to_enum(self, state_str: Optional[str]) -> Optional[State]:
        """
        ...
        return state_name_mapping.get(state_upper, None)