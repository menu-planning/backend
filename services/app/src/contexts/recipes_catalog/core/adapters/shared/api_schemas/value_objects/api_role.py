...
from src.contexts.recipes_catalog.core.domain.enums import Permission as RecipesPermission
...
class ApiRole(ApiSeedRole):
    ...
    permissions: Annotated[
        frozenset[str],
        BeforeValidator(
            lambda v: validate_permissions_collection(v, allowed_permissions={perm.value for perm in RecipesPermission})
        ),
