...
from src.contexts.seedwork.shared.adapters.api_schemas.validators import validate_optional_text_length, validate_rating_range
...
RatingCommentOptional = Annotated[
    ...
    AfterValidator(lambda v: validate_optional_text_length(v, 1000, "Comment must be 1000 characters or less")),
]