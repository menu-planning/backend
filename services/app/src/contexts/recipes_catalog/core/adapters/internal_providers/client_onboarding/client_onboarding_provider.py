...
import src.contexts.client_onboarding.core.endpoints.internal as client_onboarding_api
from src.contexts.recipes_catalog.core.adapters.internal_providers.client_onboarding.schemas import (
...
class ClientOnboardingProvider:
    ...
    async def get_form_response(response_id: str) -> Dict[str, Any]:
        ...
        """
        response = await client_onboarding_api.get_form_response(
    ...
    async def get_form_responses(
        ...
        """
        response = await client_onboarding_api.get_form_responses(
            caller_context="recipes_catalog",
            form_id=form_id,
            limit=limit,
            offset=offset
