...
class SuccessResponse(BaseResponse[T]):
    ...
    statusCode: int = Field(default=200, description="HTTP success status code", ge=200, le=299)
...
class CreatedResponse(BaseResponse[T]):
    ...
    statusCode: int = Field(default=201, description="HTTP created status code")
...
class NoContentResponse(BaseModel):
    ...
    statusCode: int = Field(default=204, description="HTTP no content status code")
    headers: Dict[str, str] = Field(default_factory=dict, description="HTTP response headers")
