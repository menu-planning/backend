...
Usage Pattern:
    ...
    from src.contexts.shared_kernel.schemas.collection_response import create_paginated_response
...
from src.contexts.shared_kernel.schemas.base_response import CollectionResponse
