...
class LoggingMiddleware:
    ...
    def __init__(
        ...
        Args:
            ...
            performance_warning_threshold: Warn if execution time exceeds threshold (seconds)
        """
    ...
    def extract_request_metadata(self, event: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            "multi_value_query_parameters": event.get("multiValueQueryStringParameters"),
            "headers": {
    ...
    async def log_request_response(
        ...
        self.structured_logger.info(
            ...
            request_body=self.sanitize_body_for_logging(request_body) if self.log_request_body else None,
    ...
    def log_response(
        ...
        self.structured_logger.info(
            ...
            resource_path=request_metadata["resource_path"],
            user_id=user_context.get("user_id"),
            response_body=self.sanitize_body_for_logging(response_body) if self.log_response_body else None,
    ...
    async def __call__(
        ...
        """
        async def wrapped_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
