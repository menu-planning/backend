...
This module defines specialized exceptions for API schema validation and conversion operations.
...
class ApiSchemaError(Exception):
    ...
    def __init__(self, message: str, schema_class: Optional[Type] = None, **kwargs):
...
class DuplicateItemError(ApiSchemaError):
    ...
    def __init__(
        ...
        duplicate_key: str,
        duplicate_value: Any,
        duplicate_items: Optional[list] = None,
        schema_class: Optional[Type] = None,
        **kwargs
    ):
        super().__init__(message, schema_class, **kwargs)
    ...
    def create_pydantic_error(
        ...
        return PydanticCustomError(
            ...
            'Duplicate {item_type} found in {field}: {duplicate_count} items have {duplicate_key}={duplicate_value}',
            {
                'item_type': item_type,
                'field': field,
...
class FieldMappingError(ApiSchemaError):
    ...
    def __init__(
        ...
        type_mismatches: Optional[Dict[str, tuple]] = None,
