from typing import Any, Set, FrozenSet, List, Optional
...
class TypeConversionUtility:
    ...
    def uuid_to_string(uuid_value: Optional[UUID]) -> Optional[str]:
        ...
        try:
            ...
            raise ValidationConversionError(
                message=f"Failed to convert UUID to string: {str(e)}",
    ...
    @staticmethod
    def string_to_uuid(string_value: Optional[str]) -> Optional[UUID]:
        ...
        try:
            ...
            raise ValidationConversionError(
                message=f"Failed to convert string to UUID: '{string_value}' is not a valid UUID format",
    ...
    @staticmethod
    def enum_to_string(enum_value: Optional[Enum]) -> Optional[str]:
    ...
    @staticmethod
    def string_to_enum(string_value: Optional[str], enum_class: type[Enum]) -> Optional[Enum]:
        ...
        try:
            ...
            raise ValidationConversionError(
                message=f"'{string_value}' is not a valid {enum_class.__name__} value. Valid values: {valid_values}",
    ...
    @staticmethod
    def list_to_frozenset(list_value: Optional[List[Any]]) -> Optional[FrozenSet[Any]]:
    ...
    @staticmethod
    def frozenset_to_list(frozenset_value: Optional[FrozenSet[Any]]) -> Optional[List[Any]]:
    ...
    @staticmethod
    def datetime_to_isostring(datetime_value: Optional[datetime]) -> Optional[str]:
    ...
    @staticmethod
    def isostring_to_datetime(isostring_value: Optional[str]) -> Optional[datetime]:
        ...
        if isostring_value is None:
            return None
        try:
            return datetime.fromisoformat(isostring_value.replace('Z', '+00:00'))
        except (ValueError, AttributeError) as e:
            raise ValidationConversionError(
                message=f"Failed to convert string to datetime: '{isostring_value}' is not a valid ISO 8601 format",
    ...
    @staticmethod
    def decimal_to_float(decimal_value: Optional[Decimal]) -> Optional[float]:
    ...
    @staticmethod
    def float_to_decimal(float_value: Optional[float], precision: int = 2) -> Optional[Decimal]:
    ...
    @staticmethod
    def frozenset_to_comma_string(frozenset_value: Optional[FrozenSet[str]]) -> Optional[str]:
        """Convert frozenset of strings to comma-separated string.
        
        Used for ORM storage where collections are denormalized as comma-separated values.
    ...
    @staticmethod
    def comma_string_to_frozenset(comma_string: Optional[str]) -> Optional[FrozenSet[str]]:
