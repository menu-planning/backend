...
SanitizedTextOptional = Annotated[str | None, Field(default=None), BeforeValidator(validators.sanitize_text_input)]
...
PhoneFieldOptional = Annotated[str | None, Field(default=None), BeforeValidator(validators.validate_phone_format)]

UrlOptional = Annotated[HttpUrl | None, Field(default=None), BeforeValidator(validators.validate_url_optinal)]

CreatedAtValue = Annotated[datetime, Field(default=datetime.now()), AfterValidator(validators.timestamp_check)]