...
class UnitOfWork(ABC):
    ...
    def __init__(
        ...
        Args:
            session_factory: a :class`async_sessionmaker <sqlalchemy.ext.asyncio.async_sessionmaker>` instance
        """
        self.session_factory = session_factory

    @abstractmethod
    async def __aenter__(self):
        """Support the async contextmanager protocol to allow easier visualization of what blocks
        of code are grouped together and initializing database session and repositories.
        """
