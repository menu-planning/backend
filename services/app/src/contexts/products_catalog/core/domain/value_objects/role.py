...
class Role(SeedRole):
    ...
    def administrator(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.ADMINISTRATOR.permissions),
        )
    ...
    def user_manager(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.USER_MANAGER.permissions),
        )
    ...
    def product_manager(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.PRODUCT_MANAGER.permissions),
        )
    ...
    def auditor(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.AUDITOR.permissions),
        )
    ...
    def user(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.USER.permissions),
        )
    ...
    def developer(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.DEVELOPER.permissions),
        )
    ...
    def support_staff(cls) -> Role:
        return Role(
            ...
            permissions=set(EnumRoles.SUPPORT_STAFF.permissions),
        )
