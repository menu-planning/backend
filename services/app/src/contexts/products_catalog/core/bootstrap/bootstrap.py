...
from src.contexts.products_catalog.core.domain import commands, events
from src.contexts.products_catalog.core.services import (
    command_handlers as cmd_handlers,
)
from src.contexts.products_catalog.core.services import event_handlers as evt_handlers
