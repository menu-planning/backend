...
def get_next_api_recipe_id() -> int:
...
def get_next_api_ingredient_id() -> int:
...
def get_next_api_rating_id() -> int:
...
def get_next_orm_product_id() -> int:
...
def get_next_orm_source_id() -> int:
...
def get_next_orm_category_id() -> int:
