...
def get_user_filter_scenarios() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "user_kwargs": {
                "id": "role_user",
                "roles": [Role(name="administrator", context="IAM", permissions=["admin"])]
            },
...
def get_user_filter_scenarios_orm() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "user_kwargs": {
                "id": "role_user",
                "roles": [create_role_orm(name="administrator", context="IAM", permissions="admin")]
            },
            "filter": {"context": "IAM", "name": "administrator"},
            "should_match": True,
            "description": "User with role should match role filter"
        },
        {
            ...
            "user_kwargs": {
                ...
                "discarded": False,
                "version": 2,
                "roles": [create_role_orm(name="user_manager", context="IAM", permissions="read, write, manage_users")]
            },
        ...
        },
        {
            ...
            "user_kwargs": {
                ...
                "roles": [
                    ...
                    create_role_orm(name="administrator", context="IAM", permissions="read, write, delete, admin")
                ]
            },
            "filter": {"name": "administrator"},
            "should_match": True,
    ...
    return [
        ...
        },
        {
            ...
            "user_kwargs": {
                ...
                "roles": [
                    create_role_orm(name="user", context="IAM", permissions="read"),
                    create_role_orm(name="user_manager", context="IAM", permissions="read, write, manage_users")
                ]
            },
        ...
        },
        {
            ...
            "user_kwargs": {
                "id": "auditor_user",
                "roles": [create_role_orm(name="auditor", context="IAM", permissions="read, audit")]
            },
...
def create_multi_role_user(**kwargs) -> User:
    ...
    final_kwargs = {
        ...
        "roles": kwargs.get("roles", [Role.user(), Role.user_manager(), Role.auditor()]),
        **{k: v for k, v in kwargs.items() if k not in ["id", "roles"]}
    }
    return create_user(**final_kwargs)
...
def create_users_with_roles_orm(count: int = 3, roles_per_user: int = 2) -> List[UserSaModel]:
    """
...
def create_test_dataset(user_count: int = 100, roles_per_user: int = 1) -> Dict[str, Any]:
    """
...
def create_test_dataset_orm(user_count: int = 100, roles_per_user: int = 1) -> Dict[str, Any]:
    """
