...
class TestApiRatingFieldValidation:
    ...
    def test_comprehensive_field_validation_with_all_constraints(self):
        ...
        assert comprehensive_rating.comment is None or len(comprehensive_rating.comment) <= 1000
        ...
        assert comprehensive_rating.comment is None or isinstance(comprehensive_rating.comment, str)
...
class TestApiRatingJsonValidation:
    ...
    def test_json_validation_with_complete_rating_data(self):
        ...
        assert api_rating.comment is not None and "Amazing recipe!" in api_rating.comment
...
class TestApiRatingErrorHandling:
    ...
    def test_json_validation_with_invalid_json_syntax_raises_error(self):
        ...
        invalid_json = '{"user_id": "test", "recipe_id": "test", "taste": 4,}'  # trailing comma
...
class TestApiRatingEdgeCases:
    ...
    def test_extreme_rating_scenarios(self):
        ...
        extreme_scenarios = [
            create_api_rating(taste=0, convenience=5, comment="No taste but super easy"),
            create_api_rating(taste=5, convenience=0, comment="Amazing taste but extremely difficult"),
            ...
            create_api_rating(taste=3, convenience=3, comment=None),  # Average with no comment
        ]
...
class TestApiRatingPerformanceValidation:
    ...
    def test_field_validation_performance(self):
        ...
        assert execution_time < 100.0, f"Field validation performance failed: {execution_time:.2f}ms > 100ms"
    ...
    def test_specialized_factory_performance(self):
        ...
        assert execution_time < 100.0, f"Factory performance failed: {execution_time:.2f}ms > 100ms"
