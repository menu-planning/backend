...
class TestApiCreateRecipeBasicSerialization:
    ...
    def test_serialization_and_deserialization(self):
        ...
        assert recreated_recipe.ingredients is not None and original_recipe.ingredients is not None
...
class TestApiCreateRecipeComplexSerialization:
    ...
    def test_serialization_with_all_fields_populated(self):
        ...
        assert recreated_recipe.ingredients is not None and recipe.ingredients is not None
    ...
    def test_serialization_with_unicode_characters(self):
        ...
        assert recreated_recipe.description is not None and "naïve" in recreated_recipe.description
        assert recreated_recipe.notes is not None and "émojis" in recreated_recipe.notes and "🔥" in recreated_recipe.notes
...
class TestApiCreateRecipeSerializationFormat:
    ...
    def test_json_structure_contains_required_fields(self):
        ...
        required_fields = ['name', 'instructions', 'author_id', 'meal_id', 'ingredients', 'tags']
...
class TestApiCreateRecipeRoundTripSerialization:
    ...
    def test_multiple_round_trips(self):
        ...
        if current_recipe.ingredients is not None and original_recipe.ingredients is not None:
    ...
    def test_round_trip_preserves_complex_objects(self):
        ...
        ingredients = frozenset([
            create_api_ingredient(name='Complex Ingredient', quantity=123.45, unit=MeasureUnit.GRAM, position=0),
        ])
        
        tags = frozenset([
            create_api_recipe_tag(key='complex-key', value='complex-value', author_id=author_id),
        ])
