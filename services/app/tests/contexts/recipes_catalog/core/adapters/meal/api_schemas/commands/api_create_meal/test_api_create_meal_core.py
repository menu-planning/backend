...
class TestApiCreateMealBasics:
    ...
    def test_meal_with_multiple_recipes_complex_structure(self):
        ...
        custom_recipes = [
            create_simple_api_recipe(name="Starter Salad", author_id=author_id, meal_id=meal_id),
            create_complex_api_recipe(name="Main Course Pasta", author_id=author_id, meal_id=meal_id),
            create_simple_api_recipe(name="Dessert Ice Cream", author_id=author_id, meal_id=meal_id),
        ]
        ...
        assert recipe_names == {"Starter Salad", "Main Course Pasta", "Dessert Ice Cream"}
    ...
    def test_meal_hierarchical_structure_validation(self):
        ...
        recipes_for_meal = [
            create_simple_api_recipe(name="Recipe A", author_id=author_id, meal_id=meal_id),
            create_simple_api_recipe(name="Recipe B", author_id=author_id, meal_id=meal_id),
        ]
        
        kwargs = create_api_create_meal_with_custom_recipes(
            author_id=author_id,
            recipes=recipes_for_meal,
            name="Parent Meal"
        )
...
class TestApiCreateMealDomainConversion:
    ...
    def test_domain_conversion_with_all_fields(self):
        ...
        assert domain_command.image_url == str(api_meal.image_url) if api_meal.image_url else None
...
class TestApiCreateMealIntegration:
    ...
    def test_integration_with_all_fixtures(self, valid_api_create_meal_kwargs, minimal_api_create_meal_kwargs):
    ...
    def test_new_helper_functions_comprehensive(self):
        ...
        kwargs4 = create_minimal_api_create_meal_with_author_id(author_id, name="Test Meal 4")
        ...
        custom_recipes = [create_simple_api_recipe(name="Custom Recipe", author_id=author_id)]
        ...
        custom_recipes = [create_simple_api_recipe(name="Recipe 1", author_id=author_id)]
        custom_tags = [{"key": "cuisine", "value": "asian"}]
        kwargs7 = create_api_create_meal_with_recipes_and_tags(author_id, custom_recipes, custom_tags)
    ...
    def test_meal_as_parent_entity_complexity(self):
        ...
        assert domain_command.recipes is not None  # Ensure not None for set comprehension
