...
class TestMenuSortingBehaviors:
    ...
    def test_sorted_meals_should_order_chronologically_across_weeks(self):
        ...
        meals = [
            create_menu_meal(meal_id="meal_3", week=2, weekday="Qua", meal_type="almoço"),
            create_menu_meal(meal_id="meal_1", week=1, weekday="Seg", meal_type="café da manhã"),
            create_menu_meal(meal_id="meal_4", week=2, weekday="Seg", meal_type="jantar"),
            create_menu_meal(meal_id="meal_2", week=1, weekday="Dom", meal_type="almoço"),
        ]
        ...
        actual_order = [(meal.meal_id, meal.week, meal.weekday) for meal in sorted_meals]
    ...
    def test_sorted_meals_should_be_deterministic_with_same_week_and_weekday(self):
        ...
        meals = [
            create_menu_meal(meal_id="meal_dinner", week=1, weekday="Seg", meal_type="jantar"),
            create_menu_meal(meal_id="meal_lunch", week=1, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="meal_breakfast", week=1, weekday="Seg", meal_type="café da manhã"),
        ]
        menu.meals = set(meals)
...
class TestMenuMealUpdateBehaviors:
    ...
    def test_update_meal_should_handle_nonexistent_meal_gracefully(self):
        ...
        menu = create_menu()
        existing_meal = create_menu_meal(meal_id="existing", week=1, weekday="Seg", meal_type="almoço")
        menu.add_meal(existing_meal)
        
        initial_version = menu.version
        
        # Try to update a meal that doesn't exist on this menu
        nonexistent_meal = create_menu_meal(meal_id="nonexistent", week=1, weekday="Ter", meal_type="jantar")
    ...
    def test_update_meal_should_be_idempotent(self):
        ...
        menu = create_menu()
        original_meal = create_menu_meal(meal_id="test_meal", week=1, weekday="Seg", meal_type="almoço")
...
class TestMenuFilteringBehaviors:
    ...
    def test_filter_meals_should_handle_partial_week_filter(self):
        ...
        meals = [
            ...
            create_menu_meal(meal_id="w2_2", week=2, weekday="Qua", meal_type="café da manhã"),
        ]
        menu.meals = set(meals)
    ...
    def test_filter_meals_should_handle_partial_weekday_filter(self):
        ...
        meals = [
            create_menu_meal(meal_id="mon_1", week=1, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="mon_2", week=2, weekday="Seg", meal_type="jantar"),
            create_menu_meal(meal_id="tue_1", week=1, weekday="Ter", meal_type="café da manhã"),
            create_menu_meal(meal_id="wed_1", week=1, weekday="Qua", meal_type="almoço"),
        ]
        menu.meals = set(meals)
    ...
    def test_filter_meals_should_return_empty_for_no_matches(self):
        ...
        meals = [
            create_menu_meal(meal_id="meal_1", week=1, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="meal_2", week=1, weekday="Ter", meal_type="jantar"),
        ]
        menu.meals = set(meals)
    ...
    def test_filter_meals_should_handle_multiple_partial_criteria(self):
        ...
        meals = [
            create_menu_meal(meal_id="match", week=1, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="wrong_week", week=2, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="wrong_day", week=1, weekday="Ter", meal_type="almoço"),
            create_menu_meal(meal_id="wrong_type", week=1, weekday="Seg", meal_type="jantar"),
        ]
        menu.meals = set(meals)
...
class TestMenuFirstMealBehaviors:
    ...
    def test_weekday_of_first_meal_should_find_earliest_weekday_on_week_1(self):
        ...
        meals = [
            ...
            create_menu_meal(meal_id="wed", week=1, weekday="Qua", meal_type="café da manhã"),
        ]
        menu.meals = set(meals)
    ...
    def test_weekday_of_first_meal_should_handle_multiple_meals_same_earliest_day(self):
        ...
        meals = [
            create_menu_meal(meal_id="mon_lunch", week=1, weekday="Seg", meal_type="almoço"),
            create_menu_meal(meal_id="mon_dinner", week=1, weekday="Seg", meal_type="jantar"),
            create_menu_meal(meal_id="tue", week=1, weekday="Ter", meal_type="café da manhã"),
        ]
        menu.meals = set(meals)
...
class TestMenuTagValidationBehaviors:
    ...
    def test_tags_setter_should_validate_all_tags_have_matching_author_id(self):
        ...
        invalid_tags = {
            ...
            create_menu_tag(key="style", value="fancy", author_id="different_user"),  # Invalid
        }
    ...
    def test_tags_setter_should_validate_all_before_accepting_any(self):
        ...
        initial_tags = {create_menu_tag(key="diet", value="paleo", author_id="user_123")}
        menu.tags = initial_tags
        
        # Try to set mix of valid and invalid tags
        mixed_tags = {
            create_menu_tag(key="diet", value="mediterranean", author_id="user_123"),  # Valid
            create_menu_tag(key="occasion", value="party", author_id="wrong_user"),    # Invalid
        }
...
class TestMenuDeletionBehaviors:
    ...
    def test_delete_should_mark_menu_as_discarded_and_generate_event(self):
        ...
        menu = create_menu()
        menu.add_meal(create_menu_meal(meal_id="test", week=1, weekday="Seg", meal_type="almoço"))
        ...
        assert getattr(deletion_event, 'menu_id') == menu.id
    ...
    def test_delete_should_prevent_further_operations(self):
        ...
        with pytest.raises(Exception):  # Should raise some kind of "discarded" exception
            _ = menu.meals
...
class TestMenuUpdatePropertiesBehaviors:
    ...
    def test_update_properties_should_handle_multiple_properties(self):
        ...
        # Create valid tags
        new_tags = {create_menu_tag(key="diet", value="vegan", author_id=menu.author_id)}
        
        # Update multiple properties
        menu.update_properties(
    ...
    def test_update_properties_should_handle_business_rule_validation(self):
        ...
        invalid_tags = {create_menu_tag(key="diet", value="vegan", author_id="wrong_user")}
