...
class TestClientPropertyManagement:
    ...
    def test_client_profile_update_with_same_value_increments_version(self, sample_client):
...
class TestClientMenuManagement:
    ...
    def test_client_create_menu_behavior(self, client_with_menus):
        ...
        menu_tags = {Tag(key="season", value="winter", author_id="menu_author", type="menu")}
    ...
    def test_client_discarded_menus_property(self, client_with_menus):
        ...
        assert menu_1.discarded  # But the menu objects themselves are marked as discarded
...
class TestClientTagManagement:
    ...
    def test_client_tags_property_handles_empty_set(self, tagged_client):
        ...
        initial_tags = {Tag(key="temp", value="test", author_id="tag_author", type="client")}
