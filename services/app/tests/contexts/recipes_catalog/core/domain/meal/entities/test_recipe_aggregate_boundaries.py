...
class TestRecipeProtectedSetterConvention:
    ...
    def test_update_properties_routes_to_protected_setters(self, recipe_outside_meal: _Recipe):
        ...
        recipe_outside_meal.update_properties(
            name="Updated via update_properties",
    ...
    def test_update_properties_validates_property_names(self, recipe_outside_meal: _Recipe):
        """update_properties should validate that properties exist."""
        with pytest.raises(AttributeError, match="Recipe has no property 'nonexistent'"):
            recipe_outside_meal.update_properties(nonexistent="value")
    
    def test_update_properties_rejects_private_properties(self, recipe_outside_meal: _Recipe):
...
class TestRecipeActionMethodConvention:
    ...
    def test_rate_method_works_directly(self, recipe_outside_meal: _Recipe):
        ...
        original_ratings_count = len(recipe_outside_meal.ratings) if recipe_outside_meal.ratings else 0
...
class TestMealRecipeMutationAllowed:
    ...
    def test_meal_can_mutate_recipe_rating(self, meal_with_recipe: tuple[Meal, _Recipe]):
...
class TestBoundaryEnforcementDocumentation:
    ...
    def test_recipe_created_with_class_constructor_follows_convention(self, sample_nutri_facts: NutriFacts):
        """Recipe created directly with constructor should follow Pythonic conventions."""
        ingredients = [create_ingredient(name="Direct ingredient", quantity=100.0, position=0)]
    ...
    def test_recipe_created_with_create_recipe_follows_convention(self, sample_nutri_facts: NutriFacts):
        """Recipe created with class method should follow Pythonic conventions."""
        ingredients = [create_ingredient(name="Class method ingredient", quantity=150.0, position=0)]
