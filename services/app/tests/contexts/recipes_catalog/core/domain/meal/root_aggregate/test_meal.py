...
class TestMealCharacterisation:
    ...
    def test_meal_cache_isolation_bug(self):
        ...
        recipe2 = create_recipe(
            nutri_facts=NutriFacts(
                calories=200.0, protein=20.0, carbohydrate=40.0, total_fat=10.0,
                saturated_fat=4.0, trans_fat=0.0, dietary_fiber=6.0, sodium=400.0, sugar=10.0
            )
        )
        ...
        assert nutri1_second is not None and nutri1_second.calories.value == 100.0  # This may fail due to shared cache
