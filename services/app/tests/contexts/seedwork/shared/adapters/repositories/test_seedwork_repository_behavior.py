...
class TestSaGenericRepositoryBehaviorDocumentation:
    ...
    async def test_postfix_operator_behavior_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_join_behavior_documentation(self, meal_repository, recipe_repository, test_session):
        """
    ...
    async def test_list_filter_behavior_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_not_in_operator_behavior_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_composite_field_behavior_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_real_world_usage_scenario_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_null_value_handling_behavior_documentation(self, meal_repository, test_session):
        """
    ...
    async def test_constraint_violation_behavior_documentation(self, meal_repository, test_session):
        """
        ...
        assert "duplicate key value" in str(exc_info.value) or "unique constraint" in str(exc_info.value).lower()
