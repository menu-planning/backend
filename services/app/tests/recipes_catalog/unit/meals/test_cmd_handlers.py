...
from src.contexts.recipes_catalog.shared.domain.commands.meals.add_recipe import (
    AddRecipeToMeal,
)
...
from src.contexts.recipes_catalog.shared.domain.commands.meals.remove_recipe import (
    RemoveRecipeFromMeal,
)
from src.contexts.recipes_catalog.shared.domain.commands.meals.update_meal import (
    UpdateMeal,
)
from src.contexts.recipes_catalog.shared.domain.commands.meals.update_recipe import (
    UpdateRecipeOnMeal,
)
