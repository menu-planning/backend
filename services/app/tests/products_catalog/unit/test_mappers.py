...
def test_map_product(
    ...
    domain_model = Product(
        ...
        food_group_id=random.choice(list(FoodGroupNames)).value,
        process_type_id=random.choice(list(ProcessTypeNames)).value,
        diet_types_ids=set([random_attr("diet_types")] * 2),
    ...
    assert len(domain_model.diet_types_ids) > 0
    if score:
    ...
    # assert reverted_domain.diet_types_ids == domain_model.diet_types_ids
