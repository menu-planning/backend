...
def bootstrap(
    ...
    injected_command_handlers: dict[type[SeedworkCommand], partial[Coroutine]] = {
        meal_commands.CreateRecipe: partial(meal_cmd_handlers.create_recipe_handler),
        meal_commands.CopyRecipe: partial(meal_cmd_handlers.copy_recipe_handler),
        meal_commands.DeleteRecipe: partial(meal_cmd_handlers.delete_recipe_handler),
        meal_commands.UpdateRecipe: partial(meal_cmd_handlers.update_recipe_handler),
        meal_commands.CreateMeal: partial(meal_cmd_handlers.create_meal_handler),
        meal_commands.DeleteMeal: partial(meal_cmd_handlers.delete_meal_handler),
        meal_commands.UpdateMeal: partial(meal_cmd_handlers.update_meal_handler),
        meal_commands.CopyMeal: partial(meal_cmd_handlers.copy_meal_handler),
        client_commands.CreateClient: partial(client_cmd_handlers.create_client_handler),
        client_commands.DeleteClient: partial(client_cmd_handlers.delete_client_handler),
        client_commands.UpdateClient: partial(client_cmd_handlers.update_client_handler),
        client_commands.CreateMenu: partial(client_cmd_handlers.create_menu_handler),
        client_commands.DeleteMenu: partial(client_cmd_handlers.delete_menu_handler),
        client_commands.UpdateMenu: partial(client_cmd_handlers.update_menu_handler),
    }
    return MessageBus(
        uow_factory=uow_factory,
