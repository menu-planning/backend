...
class ApiRecipe(BaseApiEntity[_Recipe, RecipeSaModel]):
    ...
    def to_domain(self) -> _Recipe:
        ...
        return _Recipe(
            ...
            ingredients=(
                [i.to_domain() for i in self.ingredients] if self.ingredients else None
            ),
    ...
    def from_orm_model(cls, orm_model: RecipeSaModel) -> "ApiRecipe":
        ...
        return cls(
            ...
            privacy=(
                Privacy(orm_model.privacy) if orm_model.privacy else Privacy.PRIVATE
            ),
    ...
    def to_orm_kwargs(self) -> dict[str, Any]:
        ...
        return {
            ...
            "ratings": (
                [r.to_orm_kwargs() for r in self.ratings] if self.ratings else []
            ),
            "nutri_facts": (
