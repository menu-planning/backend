...
class Entity(abc.ABC):
    """Enhanced Entity base class with instance-level caching
    and aggregate boundary support.
    ...
    **📊 Cache Management Examples:**
    ...
    # Returns: {
    # 'total_cached_properties': 3, 'computed_caches': 2,
    # 'cache_names': [...]}
    ```
    ...
    **Core Attributes:**
        ...
        _computed_caches: Read-only set of cached property names computed on this
                        instance
    ...
    **Update Methods:**
        update_properties(**kwargs): Public API for property updates with standardized
                                    contract
        _update_properties(**kwargs): Enhanced implementation supporting multiple setter
                                    patterns
    ...
    **See Also:**
    ...
    def __init_subclass__(cls, **kwargs):
        """Automatically detect and register cached properties
