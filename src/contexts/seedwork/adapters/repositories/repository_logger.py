...
class RepositoryLogger:
    ...
    This class provides comprehensive logging capabilities for repository operations
    with automatic correlation ID generation, context management, performance tracking,
    ...
    Features:
        ...
        - Environment-based debug level control
    ...
    Environment Controls:
        REPOSITORY_DEBUG: Enable all repository debug logging
        DEBUG_CONTEXTS: Comma-separated list of specific debug contexts
        {CONTEXT}_DEBUG: Enable specific context debugging
        VERBOSE_PERFORMANCE: Enable detailed performance logging
    """
    ...
    def debug_conditional(self, message: str, context: str = "general", **kwargs):
        ...
        This method allows you to keep debug statements in code but only see them
        when needed through environment variable configuration.
    ...
    def disable_debug_for_session(self):
        ...
        debug_vars = [k for k in os.environ if k.endswith('_DEBUG')]
