...
class TypeConversionUtility:
    ...
    type representations commonly used across domain, API, and ORM layers. It ensures
    consistent type handling and provides clear error messages for conversion failures.
    ...
    Error Handling:
        All conversion methods raise ValidationConversionError with detailed
        context when conversions fail, making debugging easier.
    """
