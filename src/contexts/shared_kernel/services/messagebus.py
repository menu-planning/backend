...
class MessageBus[U: UnitOfWork]:
    ...
    are processed in separate task groups to ensure independence from command
    execution. Maintains transaction boundaries through UnitOfWork integration.
    ...
    Notes:
        ...
        Events: Processed independently - failures don't affect commands.
    """
